...
/// struct for typed errors of method [`drive_about_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DriveAboutGetError {
    UnknownValue(serde_json::Value),
}


/// Gets information about the user, the user's Drive, and system capabilities.
pub async fn drive_about_get(configuration: &configuration::Configuration, alt: Option<&str>, fields: Option<&str>, key: Option<&str>, oauth_token: Option<&str>, pretty_print: Option<bool>, quota_user: Option<&str>, user_ip: Option<&str>) -> Result<crate::models::About, Error<DriveAboutGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DriveAboutGetError> = serde_json::from_str(&local_var_content).ok();
